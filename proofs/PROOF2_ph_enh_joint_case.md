...
`UMASHObligations.lean`, including r=1,2,3 and every 36≤r≤63.
...
It does not apply the common-offset lemma from `PROOF.md` to two
...
in `PROOF.md`, Lemma 5.2, already suffices. Otherwise all these
