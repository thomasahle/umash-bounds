...
`VERDICT.md`, the envelope (2) has score strictly between
...
As requested, the already established results of `PROOF.md` and
`PROOF2.md` are not reproved. Section 2 states precisely the
...
`<work>/umash-goal3`. Every computation and compilation runs under
