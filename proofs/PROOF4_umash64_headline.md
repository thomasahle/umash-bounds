...
[paper](https://github.com/backtrace-labs/umash/blob/master/umash.pdf),
[reference](https://github.com/backtrace-labs/umash/blob/master/umash_reference.py), and
...
* The verified one-word ENH lemma in
  `umash-enh-verify/VERDICT.md`, Section 3/Lemma 2, gives
