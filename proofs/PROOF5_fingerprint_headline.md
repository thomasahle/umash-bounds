...
[paper](https://github.com/backtrace-labs/umash/blob/master/umash.pdf), p. 12, and
[literate source](https://github.com/backtrace-labs/umash/blob/master/umash_reference.py), lines 744--774.
...
1. **Masks and affine PH slices.** For
   ...
   These are [PROOF.md](PROOF.md), Sections 3 and 5. The offset
...
2. **Primary block and identity bounds.** For any distinct valid expanded
   ...
   Sources: [PROOF3.md](PROOF3.md), Theorem 6.1 and Corollary 6.2;
   the tag bound is [PROOF2.md](PROOF2.md), Theorem 9.2.
...
4. **Joint equal-checksum PH cases.** Equal chunk counts and equal data
   ...
   - At least two PH chunks differ: <=345763417/2^116=J/q^2, with the ENH
     chunk arbitrary. Source: [subcase-b verdict](umash-subcase-b/VERDICT.md),
   ...
   - Exactly one PH chunk differs, and one final word changes: <2^37/q^2.
     Source: [ENH verdict](umash-enh-verify/VERDICT.md), Sections
   ...
   - Exactly one PH chunk differs and both final words change: for r=0
     ...
     Section 7, and [PROOF2.md](PROOF2.md), Theorem 1.
...
6. **Encoding and finalization.** Expanded block/tag lists encode long
   ...
   [PROOF.md](PROOF.md), Section 8, and
   [GAP.md](umash-lemma/GAP.md), Section 3.
...
The supplied [C header](umash-lemma/umash-src/umash.h) declares
`poly[2][2]`; each row is {f_i^2 mod p,f_i}. In
[umash.c](umash-lemma/umash-src/umash.c), `umash_fp_medium` and
...
`<work>/umash-goal5`; the Mac only read/edited files and transferred them.
