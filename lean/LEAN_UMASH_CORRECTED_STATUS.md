...
[UMASHCertified.lean](ProvenHashes/UMASHCertified.lean) and
[UMASHJointClosure.lean](ProvenHashes/UMASHJointClosure.lean):
...
[AuditAll.txt](AuditAll.txt), generated by [AuditAll.lean](AuditAll.lean).
...
* Final verification: [Verification.json](Verification.json).
* Source manifest: [SourceHashes.json](SourceHashes.json).
* Round-2 checkpoints: [Round2Checkpoints.json](Round2Checkpoints.json).
* Checkpoint coverage: [Round2Coverage.json](Round2Coverage.json).
* Prior-round checkpoints remain in [CorrectedCheckpoints.json](CorrectedCheckpoints.json).
...
* This completion report's commit is recorded in [ReportCommit.txt](ReportCommit.txt).
* Lean 4.24.0: `797c613eb9b6d4ec95db23e3e00af9ac6657f24b`.
* Mathlib v4.24.0: `f897ebcf72cd16f89ab4577d0c826cd14afaafc7`.
* Final build log: [BuildUMASHCorrected.txt](BuildUMASHCorrected.txt).
