...
All computation ran on the Xeon under `<work>/umash-verify/<lens>/`.
...
- Lens 1 (logic): `scratchpad/design/umash-verify/logic/verify_constants.py`,
  ...
  (0 failures); Xeon `<work>/umash-verify/logic/run.log`.
- Lens 2 (ENH fibre): masks64.py, enh_scaled.c, brute_check.py, enh_fibre64.c
  under `<work>/umash-verify/` on the Xeon; exhaustive_lift rerun sha256
  4ec229f0... identical.
