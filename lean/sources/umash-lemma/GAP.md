...
Heavy work ran on `<xeon>`, in `<xeon>/umash-lemma`, with `nice -n 10` and at most 48 computational threads. The Mac used one computational thread. No web access, package installation, or network operation other than SSH/SCP was used.
